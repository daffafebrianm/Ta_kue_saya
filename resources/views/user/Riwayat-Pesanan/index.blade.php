...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <div class="text-center mb-5">
            <h1 class="fw-bold text-primary mb-1">🧾 Riwayat Pesanan</h1>
            <p class="text-secondary mb-2" style="font-size: 1rem; letter-spacing: 0.2px;">
                ...
                @foreach ($orders as $o)
                    ...
                    <div class="col-xl-4 col-lg-6 col-12">
                        <div class="card order-card border-0 shadow-sm h-100 position-relative">
                            ...
                            {{-- BADGE --}}
                            <span
                                class="badge bg-{{ $status[0] }} badge-status
                      position-absolute top-0 end-0 m-3 rounded-pill">
                            ...
                            <div class="card-body ps-4">
                                ...
                                @php
                                    // Ubah metode pengiriman ke Bahasa Indonesia
                                    $method = strtolower($o->shipping_method ?? '-');
