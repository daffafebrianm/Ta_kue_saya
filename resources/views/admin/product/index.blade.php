                    ...
                    <tr>
                        ...
                        <td>
                            @if ($produk->gambar && file_exists(storage_path('app/public/' . $produk->gambar)))
                                <img src="{{ asset('storage/' . $produk->gambar) }}" alt="Gambar Produk" width="60" height="60" style="object-fit: cover; border-radius: 8px;">
                            @else
                                <span class="text-muted">Tidak ada</span>
                            @endif
                        </td>
                  <td class="text-center">
    <a href="{{ route('produk.show', $produk->id) }}" class="btn btn-sm btn-primary" title="Lihat">
